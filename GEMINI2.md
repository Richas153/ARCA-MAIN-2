...
#### Objetivo
Evaluar y categorizar los pasatiempos, deportes, estudios o actividades económicas paralelas del candidato para determinar si generan un riesgo real de interferencia temporal, física o de prioridades con la jornada y continuidad en la vacante.

#### Categorización de Actividades
- **Categoría 1 (Bajo impacto y flexibles):** Actividades recreativas genéricas o hobbies casuales que se adaptan al tiempo libre (ej. lectura, pasear, ver TV, gimnasio ocasional, videojuegos, tiempo en familia).
- **Categoría 2 (Medio impacto y estructuradas):** Actividades productivas o hobbies que requieren constancia pero permiten adaptación (ej. tutorías de fin de semana, clases nocturnas, freelance ocasional, deportes amateur regulares).
- **Categoría 3 (Alto impacto y exigencia crítica):** Actividades profesionales, semiprofesionales o negocios principales que demandan alta energía, viajes frecuentes o compromisos ineludibles (ej. deporte de alto rendimiento/ciclo olímpico, emprendimiento como fuente principal de ingresos, otro empleo fijo paralelo).

#### Evidencia Válida
- Declaraciones textuales sobre la naturaleza de la actividad en el tiempo libre.
- Especificación de horarios, frecuencia y nivel de flexibilidad de la actividad.
- Confirmación explícita sobre la jerarquía de prioridades entre la actividad y el trabajo formal.

#### Reglas de Puntuación (Binaria)
- **12 puntos (Sin riesgo):** El candidato solo reporta actividades de Categoría 1; o reporta actividades de Categoría 2 y existe evidencia explícita de que ocurren fuera del horario laboral, no requieren viajes frecuentes y no son su prioridad económica o vital sobre el empleo.
- **0 puntos (Con riesgo o sin datos):** El candidato reporta actividades de Categoría 3, ya que por su naturaleza generan conflicto de intereses, fatiga o viajes, incluso si el candidato promete que no interferirán. También aplica si las actividades de Categoría 2 se cruzan con el horario laboral, o si hay una ausencia total de información sobre el tema en la entrevista.

#### Reglas de Procesamiento e Inferencia para la IA
- Analiza la naturaleza de la actividad antes de aceptar ciegamente la afirmación del candidato; si la actividad es de Categoría 3, asume interferencia probable por desgaste físico o viajes.
- Si una actividad de Categoría 2 genera ingresos, evalúa si requiere atención al cliente o disponibilidad durante el horario laboral de la vacante; si no hay cruce, no lo consideres interferencia.
- No asumas que un hobby de Categoría 1 interfiere a menos que el candidato declare explícitamente que lo realiza durante su jornada de trabajo.
- Ante la falta absoluta de datos sobre qué hace en su tiempo libre, puntúa con 0 y registra la falta de evaluación en la entrevista.

#### Preguntas de Sondeo (Para solicitar más contexto si es necesario)
- ¿En qué días, horarios y con qué frecuencia exacta realizas esta actividad?
- ¿Esta actividad requiere viajes frecuen
...
#### Objetivo
Evaluar si el candidato acepta la remuneración y la modalidad de pago, teniendo en cuenta que las condiciones exigidas varían según el tipo de contrato y la ubicación geográfica del candidato.

#### Evidencia
- Respuesta clara de aceptación o resistencia al modelo de pago específico que le aplica al candidato (división salarial o plataforma de pago).

#### Criterios de Evaluación
Para asignar los puntos, primero identifica bajo qué modalidad se le está ofertando al candidato:
- **Contexto A (Contrato Laboral / Término Indefinido):** Aplica siempre para candidatos en Colombia, y para candidatos internacionales solo si se especifica que es contrato a término indefinido. En este caso, el candidato debe aceptar el monto total y la división salarial (ejemplo: 65% prestacional y 35% extralegal).
- **Contexto B (Contractor):** Aplica por defecto para candidatos internacionales (Kenia, Perú, México, Argentina, etc.) a menos que se indique lo contrario. En este caso, no se requiere explicar división salarial; el candidato solo debe aceptar el monto total y la plataforma o método de pago (ejemplo: Payoneer o pago quincenal).

#### Regla
- **10 puntos:** Acepta explícitamente la remuneración y el modelo de pago correspondiente a su contexto. Si es empleado directo acepta la división salarial; si es contractor acepta el método de pago. También recibe 10 puntos si tiene dudas sobre la plataforma de pago pero acepta seguir adelante con una explicación.
- **0 puntos:** Rechaza el salario, rechaza la división salarial impuesta, se niega a usar la plataforma de pago requerida sin disposición a aprender, o propone condiciones de pago fuera de contexto.

#### Ejemplos
*(Contexto A: Contrato Laboral / Exige División Salarial)*
- "Estoy de acuerdo con la remuneración total y entiendo la modalidad de 65% prestacional y 35% como pago extralegal. Para mí, esta estructura está bien." → **10**. El candidato comprende la complejidad del modelo corporativo y lo acepta sin condiciones.
- "Acepto el monto total, pero no me siento cómodo con la división 65/35. Preferiría que el 100% de mi salario fuera prestacional para asegurar mis beneficios." → **0**. Rechaza el modelo de pago específico que la empresa debe aplicar por ley/política.

*(Contexto B: Contractor / Exige Método de Pago)*
- "Entendido. Acepto la remuneración y estoy de acuerdo en recibir el pago a través de Payoneer. Ya tengo una cuenta y me parece muy práctico." → **10**.
- "El salario me parece bien, pero nunca he usado Payoneer y no estoy seguro de cómo funciona, pero si me explican sigamos adelante." → **10**. Muestra disposición y no bloquea el proceso.
- "El salario me parece bien, pero no quiero usar Payoneer porque no conozco la plataforma. ¿Podríamos hacerlo a través de una transferencia bancaria normal a mi cuenta?" → **0**. Rechaza directamente las herramientas estándar de la empresa.
